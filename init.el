...
(doom! :input
       ...
       ;;  +iosevka)        ; currently have +iosevka, +fira fonts
       ...
       (lookup           ; helps you navigate your code and documentation
        +dictionary      ; dictionary/thesaurus lookups on `SPC s t` and `SPC s T`
       ...
       (org              ; organize your plain life in plain text
        ...
        +gnuplot         ; installs gnuplot and gnuplot-mode =SPC m b p=
